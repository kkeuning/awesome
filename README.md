...
* [buildah](https://github.com/projectatomic/buildah) - A tool which facilitates building OCI images
...
* [coffeelog](https://github.com/ahmetb/coffeelog) - Sample cloud-native application hosted on Kubernetes with Google Container Engine.
...
* [envy](https://github.com/jamiealquiza/envy) - Automatically exposes environment variables for all of your flags
...
* [lets-proxy](https://github.com/rekby/lets-proxy) - Reverse proxy which automatically obtains TLS certificates from Let's Encrypt.
...
* [point](https://github.com/kshvmdn/point) - Create and manage shortened URLs with GitHub pages.
...
* [react-calendar-heatmap](https://github.com/patientslikeme/react-calendar-heatmap) - an svg calendar heatmap component, inspired by github's contribution graph
...
* [landscape](https://github.com/cncf/landscape) - Cloud Native Landscape
